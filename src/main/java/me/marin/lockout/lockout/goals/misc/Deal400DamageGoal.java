...
public class Deal400DamageGoal extends Goal implements TextureProvider, HasTooltipInfo {
    ...
    public boolean renderTexture(DrawContext context, int x, int y, int tick) {
        ...
        context.drawItemInSlot(client.textRenderer, DISPLAY_ITEM_STACK, x, y, "400");
        return true;
    }
